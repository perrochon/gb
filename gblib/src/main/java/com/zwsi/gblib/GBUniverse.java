...
public class GBUniverse {
    ...
    GBSystem[] systemsArray = new GBSystem[numberOfSystems]; // the star Systems // TODO make private an return copy in getter
    ...
    void consoleDraw() {
        ...
        System.out.println("============");
        System.out.println("The Universe contains " + numberOfSystems + " star systems.\n");
